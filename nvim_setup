...

{
  ...
  apt install -y -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold" curl fuse3 git npm build-essential >/dev/null 2>&1

  if ! command -v fzf >/dev/null 2>&1; then
    curl -Ls https://raw.githubusercontent.com/junegunn/fzf/master/install | bash >/dev/null 2>&1
  fi

  if ! command -v fd >/dev/null 2>&1; then
    curl -LsO https://github.com/sharkdp/fd/releases/download/v10.2.0/fd_10.2.0_amd64.deb >/dev/null 2>&1
  ...
  if ! command -v rg >/dev/null 2>&1; then
    curl -LsO https://github.com/BurntSushi/ripgrep/releases/download/14.1.1/ripgrep_14.1.1-1_amd64.deb >/dev/null 2>&1
    dpkg -i ripgrep_14.1.1-1_amd64.deb >/dev/null 2>&1 && rm ripgrep_14.1.1-1_amd64.deb
  fi
} &
...
{
  set -e
  curl -LsO https://github.com/neovim/neovim/releases/download/nightly/nvim-linux-x86_64.appimage >/dev/null 2>&1
